...
<div>
  <a href='https://www.ycombinator.com/launches/ObF-compyle-lovable-for-software-engineers' target="_blank">
    <img src='https://www.ycombinator.com/launches/ObF-compyle-lovable-for-software-engineers/upvote_embed.svg' alt='Launch YC: Compyle - Lovable for Software Engineers' style={{maxWidth: '100%', height: 'auto'}}/>
  </a>
</div>
...
<div>
  <iframe style={{border: '1px solid rgba(0, 0, 0, 0.1)', borderRadius: '8px', width: '100%', height: '500px'}} src="https://www.producthunt.com/embed/compyle-2?utm_source=badge-featured&utm_medium=badge&utm_source=badge-compyle-3" allowTransparency="true" frameBorder="0" scrolling="no"></iframe>
</div>

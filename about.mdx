...
<Card title="View YC Profile" href="https://www.ycombinator.com/companies/compyle" icon="arrow-right" target="_blank">
  Learn more on Y Combinator's website
</Card>

### Y Combinator Launch Badge

<a href='https://www.ycombinator.com/launches/ObF-compyle-lovable-for-software-engineers' target="_blank"><img src='https://www.ycombinator.com/launches/ObF-compyle-lovable-for-software-engineers/upvote_embed.svg' alt='Launch YC: Compyle - Lovable for Software Engineers' style="max-width: 100%; height: auto;"/></a>

### Product Hunt Launch

<iframe style="border: 1px solid rgba(0, 0, 0, 0.1); border-radius: 8px; width: 100%; height: 500px;" src="https://www.producthunt.com/embed/compyle-2?utm_source=badge-featured&utm_medium=badge&utm_source=badge-compyle-3" allowTransparency="true" frameBorder="0" scrolling="no"></iframe>
...
<Card title="Connect on LinkedIn" href="https://linkedin.com/in/jonathanyamanda" icon="linkedin" target="_blank">
...
<Card title="Connect on LinkedIn" href="https://linkedin.com/in/mark-nazzaro" icon="linkedin" target="_blank">
...
<Card title="View on Product Hunt" href="https://www.producthunt.com/products/compyle-2" icon="arrow-right" target="_blank">
...
<Card title="Start Free Trial" href="https://app.compyle.ai" icon="rocket">
...
<CardGroup cols={2}>
  <Card title="Twitter" href="https://twitter.com/compyle_ai" icon="twitter">
    @compyle_ai - Latest updates and insights
  </Card>
  <Card title="Discord" href="https://discord.gg/compyle" icon="discord">
    Join our community of 100+ early users
  </Card>
  <Card title="GitHub" href="https://github.com/compyle" icon="github">
    Contribute and collaborate
  </Card>
  <Card title="LinkedIn" href="https://linkedin.com/company/compyle" icon="linkedin">
...
**Yethikrishna R** - *Documentation & Product Strategy*
...
<CardGroup cols={3}>
  <Card title="Get Started" href="./getting-started/index" icon="rocket">
    Begin your Compyle journey
  </Card>
  <Card title="Read Our FAQ" href="./faq" icon="question">
    Answers to common questions
  </Card>
  <Card title="Join Community" href="./community" icon="users">

...
<div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '20px' }}>
  <img src="/images/team/yethikrishna-r.webp" alt="Yethikrishna R, Documentation Lead at Compyle" style={{ width: '100px', height: '100px', borderRadius: '50%', objectFit: 'cover' }} />
  <div>

**Yethikrishna R** - _Documentation Lead & Product Strategy_
...
The Compyle documentation represents our commitment to clear, comprehensive, and user-focused information architecture. Every guide, tutorial, and reference is crafted to empower engineers to collaborate effectively with AI.

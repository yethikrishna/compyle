...
{/* TODO: Add validation UI screenshot when ready
     Image path: /images/screenshots/validation-ui.png
     See /images/screenshots/README.md for requirements

## Validation in Action

![Code review and validation checks interface showing real-time validation during implementation](/images/screenshots/validation-ui.png)

*Compyle validates every code change against your custom rules and planning decisions.*
